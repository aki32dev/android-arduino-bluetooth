...
import com.mp.arduinobluetooth.adapter.PagerAdapter
import com.mp.arduinobluetooth.utils.constant.Constants
import com.mp.arduinobluetooth.databinding.ActivityMainBinding
import com.mp.arduinobluetooth.utils.bluetooth.BluetoothUtils
...
import com.mp.arduinobluetooth.ui.main.dialog.DialogList
import com.mp.arduinobluetooth.ui.main.dialog.DialogPaired
import com.mp.arduinobluetooth.utils.constant.Constants.TAB_TITLES
...
class MainActivity : AppCompatActivity() {
    ...
    fun showDialogAdd(parAdd: Boolean ,listModel: ListModel) {
        DialogList(parAdd, listModel).apply {
            setStyle(
                BottomSheetDialogFragment.STYLE_NORMAL,
                R.style.BaseBottomSheetDialog
            )
            show(supportFragmentManager, DialogList.TAG)
        }
    }
